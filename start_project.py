#!/usr/bin/env python3
"""
Скрипт для запуска всего проекта Upwork Proposal Generator
"""
...
def main():
    ...
    if check_backend():
        print("⚠️  Backend сервер уже запущен на http://localhost:8000")
    else:
